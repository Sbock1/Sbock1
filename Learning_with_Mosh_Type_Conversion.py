...
#Pypi and Pip
#www.pypi.org to find packages with new functionality and already written code
...
process_workbook("Preise.xlsx")
'''

#Machine Learning Libraries
#numpy / Pandas (dataframe) / MathPlotLib / Scikit-Learn DecisionTrees (Neual Networks)
#Jupyter
